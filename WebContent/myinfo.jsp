      ...
      <div class="formBox1" style="display:none;">									
       <form id="profile" >
              <div class="wlfg-wrap clearfix">
                ...
                <div class="rlf-group">
                  <input type="text" readonly="readonly" name="nickname" style="color:#07111b" id="nick"  autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session.student_name }" placeholder="请输入昵称."/>
                  <p class="rlf-tip-wrap errorHint color-red" ></p>
                </div>
              </div>
       </form>
       <form id="profile" >
              <div class="wlfg-wrap clearfix">
                ...
                <div class="rlf-group">
                  <input type="text" readonly="readonly" name="nickname" id="nick" style="color:#07111b" autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session.student_sex }" placeholder="请输入昵称."/>
                  <p class="rlf-tip-wrap errorHint color-red" ></p>
                </div>
              </div>
       </form>
       <form id="profile" >
              <div class="wlfg-wrap clearfix">
                ...
                <div class="rlf-group">
                  <input type="text" readonly="readonly" name="nickname" id="nick" style="color:#07111b" autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session.student_department }" placeholder="请输入昵称."/>
                  <p class="rlf-tip-wrap errorHint color-red" ></p>
                </div>
              </div>
       </form>
       <form id="profile" >
              <div class="wlfg-wrap clearfix">
                ...
                <div class="rlf-group">
                  <input type="text" readonly="readonly" name="nickname" id="nick" style="color:#07111b" autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session.student_id }" placeholder="请输入昵称."/>
                  <p class="rlf-tip-wrap errorHint color-red" ></p>
                </div>
              </div>
       </form>
        <form id="profile" >
              <div class="wlfg-wrap clearfix">
                ...
                <div class="rlf-group">
                  <input type="text" readonly="readonly" name="nickname" id="nick" style="color:#07111b" autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session.student_tel }" placeholder="请输入昵称."/>
                  <p class="rlf-tip-wrap errorHint color-red" ></p>
                </div>
              </div>
         </form>
         ...
         <div class="formBox2" style="display:none;">
          <form action="${path}updateSign_upX" method="post">									
              <div class="wlfg-wrap clearfix">
                <label class="label-name" for="nick" >姓名：</label>
                <div class="rlf-group">
                  <input type="text" name="student_name" style="color:#07111b" id="nick"  autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session.student_name }" placeholder="请输入昵称."/>
                  <p class="rlf-tip-wrap errorHint color-red" ></p>
                </div>
              </div>
              <div class="wlfg-wrap clearfix">
                <label class="label-name" for="nick" >性别：</label>
                <div class="rlf-group">
                  <input type="text" name="student_sex" id="nick" style="color:#07111b" autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session.student_sex }" placeholder="请输入昵称."/>
                  <p class="rlf-tip-wrap errorHint color-red" ></p>
                </div>
              </div>
              <div class="wlfg-wrap clearfix">
                <label class="label-name" for="nick" >学院：</label>
                <div class="rlf-group">
                  <input type="text" name="student_department" id="nick" style="color:#07111b" autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session.student_department }" placeholder="请输入昵称."/>
                  <p class="rlf-tip-wrap errorHint color-red" ></p>
                </div>
              </div>
              <div class="wlfg-wrap clearfix">
                <label class="label-name" for="nick" >学号：</label>
                <div class="rlf-group">
                  <input type="text" name="student_id" id="nick" style="color:#07111b" autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session.student_id }" placeholder="请输入昵称."/>
                  <p class="rlf-tip-wrap errorHint color-red" ></p>
                </div>
              </div>
              <div class="wlfg-wrap clearfix">
                <label class="label-name" for="nick" >电话号码：</label>
                <div class="rlf-group">
                  <input type="text" name="student_tel" id="nick" style="color:#07111b" autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="${session.student_tel }" placeholder="请输入昵称."/>
